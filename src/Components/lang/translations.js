const translations = {
    'fr' : {
        ...
        'play' : 'Commencer',
        'pause' : 'Pause',
        'alertNoSlidingDuringPlaying' : "Pas de changements de paramètres autorisés lors de l'animation. Appuyez sur pause ou stop puis changez la vitesse",
        'expTitle' : 'Les Tours d\'Hanoi',
        'expIntro' : "Les tours d'Hanoi sont un jeu simple inventé par le mathématicien " +
                      ...
                      "mit sur un autre seulement s'il est moins grand. Ainsi les " +
                      "disques sont empilés du plus grand au plus petit. L'objectif est " +
                      "alors de déplacer la pile sur un autre support, en bougeant les disques " +
                      "un par un, avec interdiction de poser un disque sur un autre disque " +
                      "plus petit que lui.",
    ...
    'us' : {
        ...
        'play' : 'Play',
        'pause' : 'Pause',
        'alertNoSlidingDuringPlaying' : 'No change of parameters allowed when animation is played. Press pause or stop button first, then change speed',
        'expTitle' : 'The Hanoi Towers',
        'expIntro' :  "The Hanoi Towers are a simple game invented by the mathematician" +
                      "French Edouard Lucas (19th century). The principle is as follows: " +
